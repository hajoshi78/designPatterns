 ...
 * Author: harsh
 *
 * Created on January 26, 2021, 1:09 AM
 */
...
{
    SortBehavior *merge = new Merge();
    SortBehavior *quick = new Quick();
    SortBehavior *heap = new Heap();

    SearchBehavior *sequential= new Sequential();
    SearchBehavior *binaryTree = new BinaryTree();
    SearchBehavior *hashTable = new HashTable();
 
    Collection*colA = new Collection();
    colA->set_sort(merge);
    colA->sort();

    Collection *colB = new Collection();
